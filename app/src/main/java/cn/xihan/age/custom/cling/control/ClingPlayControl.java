...
import cn.xihan.age.custom.cling.entity.ClingPositionResponse;
import cn.xihan.age.custom.cling.entity.ClingResponse;
import cn.xihan.age.custom.cling.entity.ClingVolumeResponse;
...
public class ClingPlayControl implements IPlayControl {
    ...
    private void setAVTransportURI(String url, final ControlCallback callback) {
        ...
        String metadata = pushMediaToRender(url);
    ...
    private String pushMediaToRender(String url) {
        long size = 0;
        long bitrate = 0;
